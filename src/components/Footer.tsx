  ...
  return (
    <div className=" bottom-0 sm:px-[100px] px-4 py-4 flex flex-col sm:flex-row sm:justify-between w-full bg-black">
      ...
      <div className="flex mt-4 w-full justify-between sm:justify-end gap-2 sm:gap-4">
        <Link
          href="/"
          className="bg-black border-2 border-white flex gap-2 sm:p-4 p-2 px-4 sm:px-8 text-white  rounded-lg justify-between sm:justify-start sm:font-medium text-[12px] sm:text-[16px]"
        >
          <img
